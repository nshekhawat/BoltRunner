...
export const DEFAULTS = {
  difficulty: 'kid', jumpAssist: false, startSpeed: 12,
  quality: 'auto', highContrast: false, reduceMotion: false, screenShake: true, palette: 'normal', showFps: false, cameraDistance: 1,
  music: 0.7, sfx: 0.9, mute: false, ambience: true,
  jumpKey: 'Space', duckKey: 'ArrowDown', touchLayout: 'right', holdSensitivity: 'normal',
  sessionMinutes: 0, ghost: true, paint: 'silver', topper: 'ball', trail: 'cyan',
};
const SCHEMA = [
  { section: 'Gameplay' },
  ...
  { key: 'jumpAssist', label: 'Jump Assist', type: 'toggle', hint: 'Auto-jumps when something is unavoidably close' },
  ...
  { key: 'reduceMotion', label: 'Reduce Motion', type: 'toggle', hint: 'No shake, fewer particles, no camera zoom' },
  ...
  { key: 'ambience', label: 'Ambience', type: 'toggle', hint: 'Wind, rain, jungle, blizzard' },
  { section: 'Controls' },
  { key: 'jumpKey', label: 'Jump key', type: 'key', hint: 'Space, ↑ and W always work too' },
  { key: 'duckKey', label: 'Duck key', type: 'key', hint: '↓ and S always work too' },
  { key: 'touchLayout', label: 'Touch layout', type: 'choice', options: [['right', 'Right-handed'], ['left', 'Left-handed']], hint: 'Which side the DUCK button sits on' },
