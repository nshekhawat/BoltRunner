...
const defaults = { best: 0, bestTime: 0, mute: false, mode: C.DIFFICULTY_DEFAULT, quality: null, records: {}, biome: 'desert' }; // records: per biome (+ 'journey') { best, bestTime, cleared, combo }
